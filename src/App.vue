<template>
  <div id="app">
    ...
    <!--底部：购物车和提交-->
    <div id ="foot">
      <div class="cartDisp" :class="{disp:isDisplay}">
      ...
      <div id="cart" v-on:click='isDisplay=!isDisplay'><img src="../static/空购物车.png"><span class="calcu">{{total | formatMoney(total)}}</span></div>
      <div class="btn1">
        <img src="../static/提交.png" @click="subFlag=!subFlag">
      </div>
    </div>
    <!--弹窗和遮罩-->
    <div class="modal modal-transition" :class="{'show':subFlag}">
